						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" id="title" name="title" placeholder="输入博客标题" class="col-xs-10 col-sm-5" value="<?php echo $data['title']; ?><?php echo $data['tags']; ?>" />
										</div>
								</div>
								<div class="form-group">
										...
										<div class="col-sm-9">
											<div class="inline">
												<input type="text" name="tags" id="form-field-tags" value="<?php echo $data['tags']; ?>" placeholder="这里输入标签，然后按确认 ..."  />
											</div>
								...
								<div class="form-group">
										...
										<div><img src="<?php echo $data['img_url']; ?>" style="width: 400px;height: 300px;" ></div>
								</div>
								<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1-1">博客内容： </label>

										<div class="col-sm-9">
											<script id="container" name="content" type="text/plain" style="width:1024px;height:500px;"><?php echo $data['content']; ?></script>
										</div>
								</div>
								<div class="form-group">
